...
while endGame != "quit":
    ...
    if (r.status_code != 200):
        endGame = input("Sorry, there was a problem in retrieving the question. Press enter to try again or type 'quit' to end the game.").lower()
        ...
        if user_answer == correct_answer:
            print("\n You Answered Correctly! The correct answer was: " + html.unescape(correct_answer))
            score_correct += 1
